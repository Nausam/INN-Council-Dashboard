...
export function DocumentRecieverListView({
  initialList,
  initialStats,
}: {
  initialList?: Awaited<ReturnType<typeof listCorrespondence>>;
  initialStats?: Awaited<ReturnType<typeof getCorrespondenceDashboardStats>>;
}) {
  ...
  const { data: listData, isPending, isError, error } =
    useCorrespondenceListQuery(listParams, { initialData: initialList });
