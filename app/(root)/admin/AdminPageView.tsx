...
import { AttendanceSyncPanel } from "@/components/admin/AttendanceSyncPanel";
...
export function AdminPageView({
  ...
  initialLeave?: Awaited<ReturnType<typeof fetchLeaveRequests>>;
  initialOvertime?: Awaited<ReturnType<typeof fetchOvertimeRequests>>;
}) {
