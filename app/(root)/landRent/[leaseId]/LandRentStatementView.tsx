...
export function LandRentStatementView({
  leaseId,
  options,
  statements,
}: {
  leaseId: string;
  options: Awaited<ReturnType<typeof fetchLandLeaseOptions>>;
  statements: Awaited<ReturnType<typeof fetchLandStatementsWithDetails>>;
}) {
  const s = useLandRentStatementPage({ leaseId, options, statements });
